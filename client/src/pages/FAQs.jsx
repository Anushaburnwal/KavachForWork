...
const FAQS = [
  {
    ...
    items: [
      { q: 'What temperature triggers a payout?', a: 'When the temperature at your GPS location crosses 45°C (IMD heatwave threshold), you become eligible to file a claim. The payout depends on severity: 45-47°C = ₹150, 47-50°C = ₹300, 50°C+ = ₹500.' },
      ...
      { q: 'How quickly is the payout credited?', a: 'Approved claims get instant wallet credit — usually within 30 seconds of verification. Flagged claims go to admin review and are resolved within 24 hours.' },
  ...
  },
  {
    ...
    items: [
      { q: 'What does ₹29/week cover?', a: 'Your weekly premium covers 7 days of heatwave insurance. If temperature crosses 45°C at your work location on any day, you can file a claim for that day\'s exposure.' },
      { q: 'What happens if I don\'t have ₹29 in my wallet on renewal day?', a: 'Your insurance is automatically deactivated. You\'ll receive a notification to top up and reactivate. No penalty — just top up and reactivate when ready.' },
